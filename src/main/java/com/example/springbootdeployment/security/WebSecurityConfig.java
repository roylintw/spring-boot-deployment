...
//                .cors(Customizer.withDefaults()) // disable this line to reproduce the CORS 401
    ...
    private CorsConfigurationSource createCorsConfig() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:5173", "http://example.com", "https://vue-deployment1-xpf6zdjama-de.a.run.app", "https://vue-deployment-xpf6zdjama-de.a.run.app")); // 請求來源
